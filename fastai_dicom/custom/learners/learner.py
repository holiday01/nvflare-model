...
from fastai.vision.all import untar_data, get_image_files, ImageDataLoaders, Learner as fastai_L, verify_images, aug_transforms, Normalize, imagenet_stats,  ToTensor, Resize, CrossEntropyLossFlat
...
class Learner(Learner):
    ...
    def initialize(self, parts: dict, fl_ctx: FLContext):
        ...
        self.train_loader = pneumothorax.dataloaders(df.values, num_workers=0)
